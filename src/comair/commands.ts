...
export const FOOD: CommandInfo[] = [
  ...
  entry(
    352,
    "Small tasty snack",
    "Any small eatable tasty stuff (like a peanut)",
    true,
  ),
  entry(
    353,
    "Big soft tasty snack",
    "Any bigger soft eatable tasty stuff (like a banana)",
    true,
  ),
  entry(
    354,
    "Tasty & suckable",
    "Any suckable tasty stuff (like oysters, spaghetti)",
    true,
  ),
  ...
  entry(
    356,
    "Hard, not tasty",
    "Any hard eatable but not tasty stuff (like a chicken bone)",
    true,
  ),
  entry(
    358,
    "Small, not tasty",
    "Any small not-tasty stuff (like pepperoni)",
    true,
  ),
  entry(
    359,
    "Big soft, not tasty",
    "Any bigger soft not-tasty stuff (like asparagus)",
    true,
  ),
...
export const REQUESTS: CommandInfo[] = [
  entry(
    813,
    "Ask personality",
    "Request Furby's current personality (starts the handshake)",
    true,
  ),
];
...
export const PERSONALITY_RESPONSES: CommandInfo[] = [
  entry(
    900,
    "No personality yet",
    "Furby has no personality developed yet",
    false,
  ),
...
export const EVENTS: CommandInfo[] = [
  entry(
    700,
    "I'm bored / sleepy",
    "Sent when idle; reaction depends on personality",
    false,
  ),
  ...
  entry(
    703,
    "Tipped over",
    "You touched my head/side, or turned me on my side",
    false,
  ),
  ...
  entry(
    705,
    "Woke up",
    'Sent on wakeup, before the "Good morning" phrase',
    false,
  ),
  ...
  entry(
    718,
    "Yawn",
    "Going to sleep; sent automatically twice entering deep sleep",
    true,
  ),
  ...
  entry(
    721,
    "Handshake song A",
    "Response to 706; as a command, sings that song",
    true,
  ),
  entry(
    722,
    "Handshake song B",
    "Response to 707; as a command, sings that song",
    true,
  ),
  entry(
    723,
    "Handshake song C",
    "Response to 708; as a command, sings that song",
    true,
  ),
  entry(
    724,
    "Handshake song D",
    "Response to 709; as a command, sings that song",
    true,
  ),
];
...
export const EXPERIMENTAL: CommandInfo[] = [
  entry(
    718,
    "Yawn",
    "Documented as sendable; normally happens automatically before deep sleep",
    true,
  ),
  entry(
    721,
    "Song A",
    "Documented as sendable; normally Furby's response to event 706",
    true,
  ),
  entry(
    722,
    "Song B",
    "Documented as sendable; normally Furby's response to event 707",
    true,
  ),
  entry(
    723,
    "Song C",
    "Documented as sendable; normally Furby's response to event 708",
    true,
  ),
  entry(
    724,
    "Song D",
    "Documented as sendable; normally Furby's response to event 709",
    true,
  ),
  entry(
    830,
    "Unknown (830)",
    "Marked as working from the official app; effect undocumented",
    true,
  ),
  entry(
    832,
  ...
  entry(
    880,
    "Dislike motion",
    "Motion reaction, generally negative/dislike",
    true,
  ),
  ...
  entry(
    887,
    "Startled",
    '"Aaah" exclamation; changes eyes to "burning" in warrior mode',
    true,
  ),
...
export const ALL_KNOWN_COMMANDS: CommandInfo[] = [
  ...
  entry(
    KEEP_ALIVE_COMMAND,
    "Keep-alive / listen mode",
    "Puts Furby in app-listening mode for ~60s; responds with current personality (90x)",
    true,
  ),
  ...ACTIONS,
  ...FOOD,
